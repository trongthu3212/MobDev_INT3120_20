 ...
 * Use the [PhoneSmsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PhoneSmsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var btnSend = view.findViewById<Button>(R.id.btnSendSms);
        var textSms = view.findViewById<EditText>(R.id.editTextSms);
        ...
        btnSend!!.setOnClickListener {
            ...
            intent.putExtra("sms_body", textSms.text);
            startActivity(intent);
        }
    }
